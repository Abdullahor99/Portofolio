    ...
    <header class="header">
      ...
      <nav id="header__nav">
        <ul class="flex f-col navi-ul">
          ...
          <li><a class="header__nav-icon  fa-solid fa-address-book" href="#contact" title="Say Hello :)" id="contacticon"></a></li>
        ...
        <div class="spalte2">
          <div id="profile" class="txt-center center-xy">
            ...
            <figure class="profile-img-figure">
              <img class="profile-img" src="img/abdullah.png" alt="Abdullah's image" />
              <img class="profile-img" src="img/abdullahsmall.png" alt="small Abdullah" />
        ...
        <div class="Projects flex">
          <div class="project1 project" name="project1">
            <figure class="project1__figure">
              <img class="project1__imge" src="img/placeimg_400_600_nature.jpg" alt="">
              <figcaption class="project1__description  center-xy">
                ...
                <a class="project1__visit-link hidden-elem" href="https://abdullahor99.github.io/traniere-Richtig-/" target="_blank">Vist Website</a>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="project2 project" name="project2">
            <figure class="project2__figure">
              <img class="project2__imge" src="img/placeimg_400_600_nature.jpg" alt="">
              <figcaption class="project2__description  center-xy">
                ...
                <a class="project2__visit-link hidden-elem" href="https://github.com/Abdullahor99/Ratingapp" target="_blank">Vist Website</a>
              </figcaption>
            </figure>
          </div>
        </div>
    ...
    <section class="contactme view inactive__view" id="contact">
      ...
      <main class="contactme__main">
        ...
        <form class="contactme__form" id="form">
          <input type="text" class="feedback-input" id="name" placeholder="Name" />
          <input type="text" class="feedback-input col-50" id="email" placeholder="Email" required onblur="isvalidEmail()" />
          <input type="text" class="feedback-input col-100" id="subject" placeholder="Subject" />
          <textarea name="message" class="feedback-input col-100" id="message" cols="30" rows="10" placeholder="Message" onblur="isvalidMessage()" required></textarea>
